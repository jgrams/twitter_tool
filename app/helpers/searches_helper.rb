module SearchesHelper
  ...
  #returns a pixel size on a scale of 200 for the svg cicle to be built at, so maps to 40-400 rather than from 0
  def scale_range_to_pixel_size(object, min, max)
