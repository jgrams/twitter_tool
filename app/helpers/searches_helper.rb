module SearchesHelper
  ...
  def scale_word_count_to_pixel_size(item, range_minimum, range_maximum, pixel_maximum, pixel_minimum)
    #this is inefficient, this should go in the helper above to save iterations
  ...
  #very similar, but will be used to make the text a link
